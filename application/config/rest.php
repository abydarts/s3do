...
|
*/
$config['rest_status_field_name'] = 'code';
...
$config['auth_override_class_method']['Home']['*'] = 'none';
$config['auth_override_class_method']['OAuth']['register'] = 'none';
$config['auth_override_class_method']['OAuth']['login'] = 'none';
$config['auth_override_class_method']['OAuth']['login_fb'] = 'none';
$config['auth_override_class_method']['OAuth']['login_google'] = 'none';
$config['auth_override_class_method']['Midtrans_Payment']['*'] = 'none';
$config['auth_override_class_method']['Midtrans']['*'] = 'none';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_valid_logins'] = ['devbaboo' => 'baboo2017'];
...
|
*/
$config['rest_key_name'] = 'BABOO-AUTH-KEY';
